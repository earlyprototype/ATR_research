...
unchanged by this addendum. Regeneration completed 2026-08-02 (issue #72
part 2): the artifact was regenerated with the attestation field against
weight files matching the addendum's three digests, and every value of
the 2026-07-25 run of record reproduced exactly (run log
`output/permutation_regen_2026-08-02.log`).
